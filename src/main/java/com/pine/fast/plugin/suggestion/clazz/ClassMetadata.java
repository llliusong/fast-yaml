...
/**
 * Represents a suggestion node that derives suggestions from java classes Every dynamic suggestion node loads PSI
 * members lazily
 */
public abstract class ClassMetadata {
    ...
    /**
     * Init properties such as. This will be called only once 1. For search, such as, name, originalName child trie,
     * e.t.c 2. Properties that are require for suggestions & documentation, such as, short & long documentation, type
     * information in short form, e.t.c
     *
     * @param module module
     */
